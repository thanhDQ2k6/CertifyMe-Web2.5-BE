-- user_id được hash nên hơn dài =))))) dữ liệu mẫu như docs
-- ==============================================================
...
('q1', 'q1', 'Java là gì?', 'Ngôn ngữ lập trình', 'Hệ điều hành', 'Cơ sở dữ liệu', 'Trình duyệt web', 'A'),
('q2', 'q1', 'vòng lặp là gì trong java?', 'Cấu trúc điều khiển', 'Biến', 'Hằng số', 'Kiểu dữ liệu', 'C');
